...
import {
  ...
  removeAdvisorLink,
  type AdvisorLink,
  type RecommendedAdvisor,
} from "@/lib/legacy-advisors";
import {
  evaluateAndHydrate,
  hydrateVaults,
  serverCheckIn,
...
function Dashboard() {
  ...
  const [advisorModal, setAdvisorModal] = useState<null | {
    mode: "choose" | "invite" | "platform";
    preset?: RecommendedAdvisor;
  }>(null);
  ...
  function handleInviteExternal(e: React.FormEvent) {
    ...
    toast.success(
      `Invite sent to ${link.email}. They'll be onboarded as your advisor once they accept.`,
    );
  }
  ...
  return (
    <PageShell>
      ...
      <div className="relative px-6 lg:px-12 pt-6 pb-32 max-w-7xl mx-auto">
        <Blob
          className="w-[480px] h-[480px] -top-20 -right-32"
          color="var(--sage)"
          opacity={0.08}
        />
        ...
        <div className="relative z-10">
          ...
          >
            ...
            <p className="mt-2 text-lg" style={{ color: "var(--warm-gray)" }}>
              Here's the state of your legacy.
            </p>
            <p className="mt-1 text-sm" style={{ color: "var(--warm-gray)", opacity: 0.7 }}>
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              ...
              {
                label: "Active Vaults",
                value: String(vaults.filter((v) => v.status === "Active").length),
              },
              ...
              >
                ...
                <p
                  ...
                  style={{
                    fontFamily: "var(--font-serif)",
                    color: s.accent ? "var(--honey)" : "var(--forest)",
                    fontSize: s.accent ? 36 : 32,
                    fontWeight: 600,
                  }}
                >
                  {s.value}
          ...
          {unfinished.length > 0 && (
            <div className="mt-12">
              ...
              <p className="mt-1 text-sm" style={{ color: "var(--warm-gray)" }}>
                These vaults didn't finish setting up. Pick one up and try again.
              </p>
                ...
                {unfinished.map((v) => {
                  ...
                  return (
                    <div
                      ...
                      style={{ borderColor: "rgba(232,160,32,0.4)" }}
                    >
                      <div className="flex items-start justify-between gap-3">
                        <div>
                          ...
                          <p className="text-xs mt-1" style={{ color: "var(--warm-gray)" }}>
                            {formatCAD(v.amount_cad)} · {v.beneficiaries.length} beneficiar
                            {v.beneficiaries.length === 1 ? "y" : "ies"}
          ...
          {completed.length === 0 ? (
            <div className="ll-card p-12 mt-6 text-center">
              ...
              <p className="mt-3 max-w-md mx-auto text-sm" style={{ color: "var(--warm-gray)" }}>
                Create your first vault to set aside funds with a release condition and an optional
                on-chain letter to your beneficiary.
              </p>
              <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
                <Link to="/create" className="ll-pill ll-pill-secondary">
            ...
            <div className="mt-6 grid md:grid-cols-2 gap-6">
              {completed.map((v) => (
                <VaultCard key={v.id} vault={v} onCheckIn={checkIn} />
              ))}
            </div>
          )}
            ...
            <div className="flex items-end justify-between flex-wrap gap-3">
              <div>
                ...
                <p className="mt-1" style={{ color: "var(--warm-gray)" }}>
                  Bring your own planner — or pick one of ours. Linked advisors get read-only access
                  to all your vaults and trustees, and a private chat with you.
                </p>
              </div>
              <button
                ...
                {links.map((l) => (
                  <div key={l.id} className="ll-card p-5">
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex items-center gap-3">
                        <div
                          ...
                          style={{
                            background: l.status === "connected" ? "var(--sage)" : "var(--cream)",
                            color: "var(--forest)",
                            fontFamily: "var(--font-serif)",
                            fontWeight: 600,
                    ...
                    <div className="mt-4 flex items-center justify-between gap-2">
                      ...
                      <button
                        onClick={() => unlink(l.id, l.name)}
                        className="text-xs"
                        style={{ color: "var(--warm-gray)", textDecoration: "underline" }}
                      >
                        Disconnect
                      </button>
                    </div>
                ...
                return (
                  <div key={a.id} className="ll-card p-5">
                    ...
                    <div className="flex items-center justify-between mt-4">
                      <span className="text-xs" style={{ color: "var(--honey)" }}>
                        ★ {a.rating}
                      </span>
                      <button
                        disabled={linked}
            ...
            >
              {advisorModal.mode === "choose" && (
                <div>
                  ...
                  <p className="mt-1 text-sm" style={{ color: "var(--warm-gray)" }}>
                    Choose how you'd like to bring an advisor onto your legacy.
                  </p>
                  <div className="mt-6 grid gap-3">
                    ...
                    >
                      ...
                      >
                        Invite my own advisor
                      </p>
                      <p className="mt-1 text-sm" style={{ color: "var(--warm-gray)" }}>
                        Send an email invite. We'll onboard them onto LegacyLink and link them to
                        your account.
                      </p>
                    </button>
                    <button
                    ...
                    >
                      ...
                      >
                        Choose a LegacyLink advisor
                      </p>
                      <p className="mt-1 text-sm" style={{ color: "var(--warm-gray)" }}>
                        Vetted Canadian planners already on the platform. Instant link.
                      </p>
                    </button>
                  </div>
                </div>
              ...
              {advisorModal.mode === "invite" && (
                <form onSubmit={handleInviteExternal}>
                  ...
                  <p className="mt-1 text-sm" style={{ color: "var(--warm-gray)" }}>
                    We'll email them a private onboarding link. Once they finish signup, you'll be
                    strongly linked.
                  </p>
                  ...
                  <p className="mt-4 text-xs" style={{ color: "var(--warm-gray)" }}>
                    They'll receive an email and an in-app notification when they create their
                    account.
                  </p>
                  <div className="mt-5 flex justify-end gap-2">
                    ...
                    <button type="submit" className="ll-pill ll-pill-primary">
                      Send invite
                    </button>
                  </div>
                </form>
              ...
              {advisorModal.mode === "platform" && (
                <div>
                  ...
                  <p className="mt-1 text-sm" style={{ color: "var(--warm-gray)" }}>
                    Each one has been vetted and is licensed in Canada.
                  </p>
        ...
        <Link
          ...
          style={{
            ...
            color: "var(--honey)",
            fontSize: 32,
            boxShadow: "0 12px 32px rgba(26,46,26,0.25)",
          }}
        >
          <span
          ...
          <span
            className="absolute right-20 whitespace-nowrap text-sm px-3 py-1.5 rounded-full opacity-0 group-hover:opacity-100 transition"
          ...
          >
            ...
            >
              ...
              <p className="mt-2 text-sm" style={{ color: "var(--warm-gray)" }}>
                "{supportFor.name}" hasn't been able to finish setup after{" "}
                {supportFor.failure_count ?? 0} attempts. Our team can complete it for you in
                minutes.
              </p>
